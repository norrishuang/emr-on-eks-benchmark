--q2.sql--
 ...
 (SELECT sold_date_sk, sales_price
  FROM (SELECT ws_sold_date_sk sold_date_sk, ws_ext_sales_price sales_price
       ...
       SELECT cs_sold_date_sk sold_date_sk, cs_ext_sales_price sales_price
        FROM dev.spectrum_iceberg_schema.store_returns.catalog_sales) x),
 wswscs AS
 (SELECT d_week_seq,
 ...
 FROM wscs, dev.spectrum_iceberg_schema.store_returns.date_dim
 ...
 (SELECT wswscs.d_week_seq d_week_seq1
  ...
  FROM wswscs,dev.spectrum_iceberg_schema.store_returns.date_dim
