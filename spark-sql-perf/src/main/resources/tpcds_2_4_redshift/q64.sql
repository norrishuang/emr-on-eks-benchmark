 ...
 cross_sales as
  (select i_product_name product_name, i_item_sk item_sk, s_store_name store_name, s_zip store_zip,
   ...
   FROM  dev.spectrum_iceberg_schema.store_returns.store_sales,
         dev.spectrum_iceberg_schema.store_returns.store_returns,
         cs_ui,
         dev.spectrum_iceberg_schema.store_returns.date_dim d1,
         dev.spectrum_iceberg_schema.store_returns.date_dim d2,
         dev.spectrum_iceberg_schema.store_returns.date_dim d3,
         ...
         dev.spectrum_iceberg_schema.store_returns.customer_demographics cd2,
            dev.spectrum_iceberg_schema.store_returns.promotion,
            dev.spectrum_iceberg_schema.store_returns.household_demographics hd1,
            dev.spectrum_iceberg_schema.store_returns.household_demographics hd2,
            dev.spectrum_iceberg_schema.store_returns.customer_address ad1,
            dev.spectrum_iceberg_schema.store_returns.customer_address ad2,
            dev.spectrum_iceberg_schema.store_returns.income_band ib1,dev.spectrum_iceberg_schema.store_returns.income_band ib2,
