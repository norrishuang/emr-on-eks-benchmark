--q80.sql--
 ...
 (select  s_store_id as store_id,
  ...
  from dev.spectrum_iceberg_schema.store_returns.store_sales left outer join dev.spectrum_iceberg_schema.store_returns.store_returns on
 ...
 (select  cp_catalog_page_id as catalog_page_id,
  ...
  from dev.spectrum_iceberg_schema.store_returns.catalog_sales left outer join dev.spectrum_iceberg_schema.store_returns.catalog_returns on
         (cs_item_sk = cr_item_sk and cs_order_number = cr_order_number),
      dev.spectrum_iceberg_schema.store_returns.date_dim,
      dev.spectrum_iceberg_schema.store_returns.catalog_page,
      dev.spectrum_iceberg_schema.store_returns.item,
      dev.spectrum_iceberg_schema.store_returns.promotion
 ...
 (select  web_site_id,
  ...
  from  dev.spectrum_iceberg_schema.store_returns.web_sales left outer join dev.spectrum_iceberg_schema.store_returns.web_returns on
