--q88.sql--
 ...
 from
   (select count(*) h8_30_to_9
    from  dev.spectrum_iceberg_schema.store_returns.store_sales a,
          dev.spectrum_iceberg_schema.store_returns.household_demographics b,
          dev.spectrum_iceberg_schema.store_returns.time_dim c,
          dev.spectrum_iceberg_schema.store_returns.store d
 ...
 from  dev.spectrum_iceberg_schema.store_returns.store_sales a3,
       dev.spectrum_iceberg_schema.store_returns.household_demographics b3,
       dev.spectrum_iceberg_schema.store_returns.time_dim c3,
       dev.spectrum_iceberg_schema.store_returns.store d3
 ...
 from  dev.spectrum_iceberg_schema.store_returns.store_sales a4,
       dev.spectrum_iceberg_schema.store_returns.household_demographics b4,
       dev.spectrum_iceberg_schema.store_returns.time_dim c4,
       dev.spectrum_iceberg_schema.store_returns.store d4
 ...
 from  dev.spectrum_iceberg_schema.store_returns.store_sales a5,
       dev.spectrum_iceberg_schema.store_returns.household_demographics b5,
       dev.spectrum_iceberg_schema.store_returns.time_dim c5,
       dev.spectrum_iceberg_schema.store_returns.store d5
 ...
 from  dev.spectrum_iceberg_schema.store_returns.store_sales a6,
       dev.spectrum_iceberg_schema.store_returns.household_demographics b6,
       dev.spectrum_iceberg_schema.store_returns.time_dim c6,
       dev.spectrum_iceberg_schema.store_returns.store  d6
