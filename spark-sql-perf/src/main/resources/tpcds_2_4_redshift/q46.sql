 ...
 from
   (select ss_ticket_number
    ...
    from  dev.spectrum_iceberg_schema.store_returns.store_sales a,
          ...
          dev.spectrum_iceberg_schema.store_returns.customer_address e
    ...
    group by ss_ticket_number,ss_customer_sk,ss_addr_sk,ca_city) dn, dev.spectrum_iceberg_schema.store_returns.customer, dev.spectrum_iceberg_schema.store_returns.customer_address current_addr
    where ss_customer_sk = c_customer_sk
      and dev.spectrum_iceberg_schema.store_returns.customer.c_current_addr_sk = current_addr.ca_address_sk
