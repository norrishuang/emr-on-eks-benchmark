...
WITH year_total AS (
 SELECT c_customer_id customer_id,
        ...
        's' sale_type
 FROM dev.spectrum_iceberg_schema.customer, dev.spectrum_iceberg_schema.store_sales, dev.spectrum_iceberg_schema.date_dim
 ...
 SELECT c_customer_id customer_id,
        ...
        'c' sale_type
 FROM dev.spectrum_iceberg_schema.customer,
