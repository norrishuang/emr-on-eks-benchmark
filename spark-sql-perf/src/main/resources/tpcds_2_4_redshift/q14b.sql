--q14b.sql--
  ...
  from  dev.spectrum_iceberg_schema.item,
     (select iss.i_brand_id brand_id, iss.i_class_id class_id, iss.i_category_id category_id
      from  dev.spectrum_iceberg_schema.store_sales,
            dev.spectrum_iceberg_schema.item iss,
     ...
     intersect
       ...
       from dev.spectrum_iceberg_schema.catalog_sales,
            dev.spectrum_iceberg_schema.item ics,
     ...
     intersect
       ...
       from  dev.spectrum_iceberg_schema.web_sales,
             dev.spectrum_iceberg_schema.item iws,
 ...
 (select 'store' channel, i_brand_id,i_class_id,i_category_id
  ...
  where ss_item_sk in (select ss_item_sk from cross_items)
    ...
    and d_week_seq = (select d_week_seq from dev.spectrum_iceberg_schema.date_dim
